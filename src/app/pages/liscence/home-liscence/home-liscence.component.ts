...
export class HomeLicenseComponent implements OnInit, AfterViewInit {
  ...
  private addLicensingStructuredData(): void {
    const licensingSchema = {
      ...
      'description': 'Partner with TileGreen to license our proprietary technology for transforming plastic waste into eco-friendly building materials in your region.',
      'provider': {
        '@type': 'Organization',
        'name': 'TileGreen',
      ...
      'audience': {
        ...
        'audienceType': 'Construction companies, Manufacturers, Sustainability-focused businesses'
      },
      'keywords': ['green technology licensing', 'sustainable building materials', 'plastic waste recycling', 'eco-friendly construction', 'circular economy']
    };
