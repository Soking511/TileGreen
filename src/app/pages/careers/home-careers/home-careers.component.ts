...
export class HomeCareersComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.updateMetadata({
      ...
      description:
        "Join TileGreen's team and help transform plastic waste into eco-friendly building materials. Explore career opportunities in green technology and sustainable construction.",
      keywords:
        'TileGreen careers, sustainability jobs, green technology careers, eco-friendly company jobs, plastic recycling careers',
