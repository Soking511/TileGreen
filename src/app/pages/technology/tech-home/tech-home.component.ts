...
@Component({
  ...
  standalone: true,
  imports: [
    FirstSectionTechComponent,
    SecondSectionTechComponent,
    FooterHomeComponent,
  ],
...
export class TechHomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.updateMetadata({
      ...
      description:
        "Discover TileGreen's proprietary technology that transforms plastic waste into high-quality, sustainable building materials. Learn about our eco-friendly manufacturing process.",
      keywords:
        'green technology, plastic recycling technology, sustainable manufacturing, eco-friendly process, circular building materials',
